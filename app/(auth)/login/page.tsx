      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl border shadow-sm p-8 space-y-5">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 border rounded-lg py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors disabled:opacity-60">
          ...
          <p className="text-center text-sm text-gray-500">
            ...
            <Link href="/signup" className="text-blue-700 font-medium hover:underline">Create one</Link>
          </p>
        </div>
      </div>
    </div>
